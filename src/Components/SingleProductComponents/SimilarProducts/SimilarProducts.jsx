    ...
    return (
        <>
            ...
            <div className="featured-2">
                ...
                <div className="new-products-card">
                    <img className="new-product-img" src="./feature-2-img.png" />
                    <div className="sepration" style={{ border: "1px solid #b4b4b4", marginTop: "5px" }}></div>
                    <p className="new-products-name">
                        MacBook Pro M2 MNEJ3 2022 LLA 13.3 inch
                    </p>
                ...
                <div className="new-products-card">
                    <img className="new-product-img" src="./feature-3-img.png" />
                    <div className="sepration" style={{ border: "1px solid #b4b4b4", marginTop: "5px" }}></div>
                    <p className="new-products-name">
                        MacBook Pro M2 MNEJ3 2022 LLA 13.3 inch
                    </p>
                ...
                <div className="new-products-card">
                    <img className="new-product-img" src="./feature-5-img.png" />
                    <div className="sepration" style={{ border: "1px solid #b4b4b4", marginTop: "5px" }}></div>
                    <p className="new-products-name">
                        MacBook Pro M2 MNEJ3 2022 LLA 13.3 inch
                    </p>
