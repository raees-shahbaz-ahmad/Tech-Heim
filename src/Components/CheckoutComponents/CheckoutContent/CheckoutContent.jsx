        ...
        <>
            <div className="checkout-container">
                <div className="user-container">
                    ...
                    <div className="edit-content-2">
                        <div className="sub-edit-content-2">
                    ...
                    <div className="edit-content-2">
                        <div className="sub-edit-content-2">
                            <p className="address-para">
                                {showAddress.street ?
                                    `${showAddress.street}, ${showAddress.city}, ${showAddress.region}` :
                ...
                <div className="left-checkout">
                            ...
                            <div className="card-content-container" >
                                        ...
                                        <div className="card-content-2" key={value.id}>
                                            ...
                                            <div className="content">
                                                ...
                                                <div className="price-content">
                                                    <div className='discounted-price'>${value.discountedPrice}</div>
                                ...
                                {!product ? (
                                    ...
                                    <div className="card-content-2">
                                        <img src={`https://ecomerceapis.runasp.net/${product.imagePath}`} alt={product.name} />
                                        <div className="content">
                                            <div className="heading">
                                                {product.name}
                                            </div>
                    ...
                    <div className="payment-details-checkout">
                        ...
                        <div className="subtotal-content">
                            ...
                            <div className="price">${shipmentCost.toFixed(2)}</div>
                        </div>
                        <div className="sepration1" style={{ border: " 1px solid lightgrey", margin: "10px 0" }}></div>
                        <div className="subtotal-content">
                            <div className="grandtotal">Grand Total</div>
                            <div className="grandprice">${grandTotal.toFixed(2)}</div>
                        </div>

                        <button onClick={handleOrderBtnClick} className="cart-btn-2">Proceed to Order</button>
                    </div>
                </div>
            </div>
